...
function invokeById(comboId) {
  switch (comboId) {
    ...
    case "combo_wqq":
      return svg(
        `${neon(["M4 14Q8 6 16 8Q20 2 32 4Q44 2 48 8Q56 6 60 14Q62 20 56 24Q58 30 48 30Q46 34 32 34Q18 34 16 30Q6 30 8 24Q2 20 4 14Z"], G.ice)}${neon(["M14 36L12 46M20 34L18 48M26 36L25 50M32 34L31 48M38 36L40 50M44 34L46 46"], G.ice)}`
      );
    case "combo_wqw":
      return svg(
        `${neon(["M2 16h26", "M2 13h26", "M2 19h26", "M2 10h26"], G.lightning)}${neon(["M4 16h22", "M6 16h18"], G.fire)}${neon(["M8 10L6 6M18 22L15 17M22 8L26 12"], G.lightning)}`
      );
    case "combo_wqe":
      return svg(
        `${neon(["M18 4L10 18h6l-2 10 12-16h-7l3-8", "M6 20L12 18L8 26", "M8 24L14 22L10 30"], G.lightning)}${neon(["M14 8L12 4L16 4Z M14 8V26M11 11h6M12 26L14 30", "M15 9L18 5V24"], G.arcane)}`
      );
    case "combo_wwq":
      return svg(
        `${neon(["M16 6L14 4L18 4Z M16 6V26M13 9h6M14 26L16 30", "M15 7L18 3V24"], G.arcane)}${neon(["M6 2L24 5L27 11L29 30L26 34L8 31L4 9Z", "M8 4L22 6L24 10L26 28L24 32L10 30L6 10Z"], G.lightning)}`
      );
    case "combo_www":
      return svg(
        `${neon([P.anchor], G.lightning)}${neon(
          [
            "M16 14L14 12L17 10L14 8L17 6L14 4L12 6L10 4L8 6L6 4L4 6L2 8",
            "M16 14L18 12L16 10L19 8L17 6L20 4L22 6L24 4L26 6L28 4L30 6",
            "M16 14L14 16L17 18L14 20L17 22L14 24L12 22L10 24L8 22L6 24L4 22L2 20",
            "M16 14L18 16L16 18L19 20L17 22L20 24L22 22L24 24L26 22L28 24L30 22",
          ],
          G.lightning
        )}${neon([P.bolt], G.lightning)}`
      );
    case "combo_wwe":
      return svg(
        `${neon([P.spiral], G.arcane)}${neon(["M28 6Q20 16 16 24Q12 16 8 8", "M8 24Q14 18 16 16"], G.ice)}${neon(["M24 4Q18 14 16 22", "M4 16Q12 14 16 16"], G.lightning)}${neon(["M6 28Q12 20 16 18", "M26 28Q22 20 16 18"], G.fire)}${neon([P.ring], G.arcane)}`
      );
    case "combo_weq":
      return svg(
