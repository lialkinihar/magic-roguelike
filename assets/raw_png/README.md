...
| `combo_wqw` | `This icon: SOLAR BEAM / FOCUSED PLASMA — ONE dominant NARROW INTENSE ENERGY BEAM crossing the frame (diagonal or horizontal), clearly a CHANNEL LASER / concentrated ray. Bright MAGENTA-WHITE to CYAN-WHITE plasma core, tight white-hot spine, softer outer glow — NOT a wide cone, NOT a fat laser disk. Only a SMALL NUMBER of SHORT LIGHTNING FORKS (2–4 branches) near the beam — sparse yellow-white electric accents, NOT a dense lightning storm or full sky bolt. NO fireball, NO ice, NO character, NO summoning circle. Flat chroma #fc03f8 only. Exactly 500x500 px. No text, no watermark.` |
...
**`combo_wqw` (WQW)** — **Solar Beam** / каналящийся луч: **узкий сфокусированный плазменный луч** (яркое ядро, мягкое свечение); **немного** коротких **ответвлений-молний** у луча, без «шторма»; фон **`#fc03f8`**.
