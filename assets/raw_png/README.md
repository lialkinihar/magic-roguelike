...
|------------|-------------------------|----------|
| **Клавиши комбинации** (маленькие повторяющиеся Q/W/E в ряд) | `rune_q`, `rune_w`, `rune_e` | `formatSkillSequenceIconsHtml` — подписи комбо (`QQE`, `WQW`, …), тултипы, строка у кулдауна Invoke |
