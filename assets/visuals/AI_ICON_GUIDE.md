...
**Три базовые способности (Q / W / E):** одна стилистика — один тип печати/руны, одна логика свечения и арканной обвязки; отличается только **центральный элемент стихии** (лёд / молния / огонь). Генерируй их **одним пакетом** или с одним и тем же «shared style» в промпте, иначе в HUD будет выбиваться.
